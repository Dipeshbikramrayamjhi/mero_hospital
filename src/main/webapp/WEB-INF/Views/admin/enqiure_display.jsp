...
<td>${list.subject }</td>
<td>${list.message }</td>
<td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#eq_delete" data-delete="${list.eid }">
<span class="fa fa-trash"></span>
</button>
</td>
<td><a href="doctor_update/${list.eid}"><i class="fa fa-edit"></i></a></td>
</tr>
...
<div class="modal fade" id="eq_delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<script>
$("#eq_delete").on("show.bs.modal",function(e)
{
var deleteid = $(e.relatedTarget).data('delete');
$("#delBtn").attr('onClick','location.href = "${pageContext.request.contextPath}/admin/enqiure_delete/' + deleteid + '"');
});
</script>
